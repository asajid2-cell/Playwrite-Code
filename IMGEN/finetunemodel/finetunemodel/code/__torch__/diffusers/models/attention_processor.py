class Attention(Module):
  ...
  to_q : __torch__.torch.nn.modules.linear.___torch_mangle_18.Linear
  to_k : __torch__.torch.nn.modules.linear.___torch_mangle_19.Linear
  to_v : __torch__.torch.nn.modules.linear.___torch_mangle_20.Linear
  to_out : __torch__.torch.nn.modules.container.___torch_mangle_23.ModuleList
  def forward(self: __torch__.diffusers.models.attention_processor.Attention,
