class Attention(Module):
  ...
  to_q : __torch__.torch.nn.modules.linear.___torch_mangle_121.Linear
  to_k : __torch__.torch.nn.modules.linear.___torch_mangle_122.Linear
  to_v : __torch__.torch.nn.modules.linear.___torch_mangle_123.Linear
  to_out : __torch__.torch.nn.modules.container.___torch_mangle_126.ModuleList
  def forward(self: __torch__.diffusers.models.attention_processor.___torch_mangle_127.Attention,
