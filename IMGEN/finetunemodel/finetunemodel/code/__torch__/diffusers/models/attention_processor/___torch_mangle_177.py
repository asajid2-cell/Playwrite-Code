class Attention(Module):
  ...
  to_q : __torch__.torch.nn.modules.linear.___torch_mangle_171.Linear
  to_k : __torch__.torch.nn.modules.linear.___torch_mangle_172.Linear
  to_v : __torch__.torch.nn.modules.linear.___torch_mangle_173.Linear
  to_out : __torch__.torch.nn.modules.container.___torch_mangle_176.ModuleList
  def forward(self: __torch__.diffusers.models.attention_processor.___torch_mangle_177.Attention,
