class Attention(Module):
  ...
  to_q : __torch__.torch.nn.modules.linear.___torch_mangle_237.Linear
  to_k : __torch__.torch.nn.modules.linear.___torch_mangle_238.Linear
  to_v : __torch__.torch.nn.modules.linear.___torch_mangle_239.Linear
  to_out : __torch__.torch.nn.modules.container.___torch_mangle_242.ModuleList
  def forward(self: __torch__.diffusers.models.attention_processor.___torch_mangle_243.Attention,
