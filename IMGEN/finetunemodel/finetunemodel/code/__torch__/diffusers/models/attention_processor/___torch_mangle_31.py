class Attention(Module):
  ...
  to_q : __torch__.torch.nn.modules.linear.___torch_mangle_25.Linear
  to_k : __torch__.torch.nn.modules.linear.___torch_mangle_26.Linear
  to_v : __torch__.torch.nn.modules.linear.___torch_mangle_27.Linear
  to_out : __torch__.torch.nn.modules.container.___torch_mangle_30.ModuleList
  def forward(self: __torch__.diffusers.models.attention_processor.___torch_mangle_31.Attention,
