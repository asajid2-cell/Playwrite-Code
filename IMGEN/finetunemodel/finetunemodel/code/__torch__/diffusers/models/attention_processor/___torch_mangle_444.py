class Attention(Module):
  ...
  to_q : __torch__.torch.nn.modules.linear.___torch_mangle_438.Linear
  to_k : __torch__.torch.nn.modules.linear.___torch_mangle_439.Linear
  to_v : __torch__.torch.nn.modules.linear.___torch_mangle_440.Linear
  to_out : __torch__.torch.nn.modules.container.___torch_mangle_443.ModuleList
  def forward(self: __torch__.diffusers.models.attention_processor.___torch_mangle_444.Attention,
