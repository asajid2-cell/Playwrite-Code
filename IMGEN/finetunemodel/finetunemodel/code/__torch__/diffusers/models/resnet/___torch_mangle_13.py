class ResnetBlock2D(Module):
  ...
  norm1 : __torch__.torch.nn.modules.normalization.___torch_mangle_6.GroupNorm
  conv1 : __torch__.torch.nn.modules.conv.___torch_mangle_7.Conv2d
  time_emb_proj : __torch__.torch.nn.modules.linear.___torch_mangle_8.Linear
  norm2 : __torch__.torch.nn.modules.normalization.___torch_mangle_9.GroupNorm
  dropout : __torch__.torch.nn.modules.dropout.___torch_mangle_10.Dropout
  conv2 : __torch__.torch.nn.modules.conv.___torch_mangle_11.Conv2d
  nonlinearity : __torch__.torch.nn.modules.activation.___torch_mangle_12.SiLU
  def forward(self: __torch__.diffusers.models.resnet.___torch_mangle_13.ResnetBlock2D,
    argument_1: Tensor,
