class Transformer2DModel(Module):
  ...
  norm : __torch__.torch.nn.modules.normalization.___torch_mangle_197.GroupNorm
  proj_in : __torch__.torch.nn.modules.conv.___torch_mangle_198.Conv2d
  transformer_blocks : __torch__.torch.nn.modules.container.___torch_mangle_223.ModuleList
  proj_out : __torch__.torch.nn.modules.conv.___torch_mangle_224.Conv2d
  def forward(self: __torch__.diffusers.models.transformers.transformer_2d.___torch_mangle_225.Transformer2DModel,
    argument_1: Tensor,
