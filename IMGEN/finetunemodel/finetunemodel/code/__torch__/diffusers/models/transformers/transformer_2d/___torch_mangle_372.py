class Transformer2DModel(Module):
  ...
  norm : __torch__.torch.nn.modules.normalization.___torch_mangle_344.GroupNorm
  proj_in : __torch__.torch.nn.modules.conv.___torch_mangle_345.Conv2d
  transformer_blocks : __torch__.torch.nn.modules.container.___torch_mangle_370.ModuleList
  proj_out : __torch__.torch.nn.modules.conv.___torch_mangle_371.Conv2d
  def forward(self: __torch__.diffusers.models.transformers.transformer_2d.___torch_mangle_372.Transformer2DModel,
    argument_1: Tensor,
