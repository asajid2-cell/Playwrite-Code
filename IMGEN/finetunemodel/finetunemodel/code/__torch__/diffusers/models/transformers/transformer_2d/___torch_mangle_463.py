class Transformer2DModel(Module):
  ...
  norm : __torch__.torch.nn.modules.normalization.___torch_mangle_435.GroupNorm
  proj_in : __torch__.torch.nn.modules.conv.___torch_mangle_436.Conv2d
  transformer_blocks : __torch__.torch.nn.modules.container.___torch_mangle_461.ModuleList
  proj_out : __torch__.torch.nn.modules.conv.___torch_mangle_462.Conv2d
  def forward(self: __torch__.diffusers.models.transformers.transformer_2d.___torch_mangle_463.Transformer2DModel,
    argument_1: Tensor,
