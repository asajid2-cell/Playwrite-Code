class Transformer2DModel(Module):
  ...
  norm : __torch__.torch.nn.modules.normalization.___torch_mangle_39.GroupNorm
  proj_in : __torch__.torch.nn.modules.conv.___torch_mangle_40.Conv2d
  transformer_blocks : __torch__.torch.nn.modules.container.___torch_mangle_65.ModuleList
  proj_out : __torch__.torch.nn.modules.conv.___torch_mangle_66.Conv2d
  def forward(self: __torch__.diffusers.models.transformers.transformer_2d.___torch_mangle_67.Transformer2DModel,
    argument_1: Tensor,
