...
(function() {
    ...
    const DEFAULT_PROFILE = {
        ...
        profile: {
            name: "Your Name Here",
            tagline: "Γ£¿ living my best life Γ£¿",
            profilePic: "",
            bannerImage: "",
            mood: { icon: "≡ƒÿÄ", text: "chillin" },
            onlineStatus: true
        },
        theme: {
            name: "glitter",
        ...
        widgets: {
            aboutMe: {
                visible: true,
                content: "<p>Hey! Thanks for visiting my page! ≡ƒÄë</p><p>This is my corner of the internet where I share my pics, music, and vibes.</p><p>Feel free to leave a comment! ≡ƒÆò</p>"
            },
            pictureWall: {
                visible: true,
                images: [],
    ...
    window.MySpace = {
        ...
        updateModeButton: function() {
            ...
            if (toggleBtn) {
                ...
                if (this.viewMode) {
                    if (icon) icon.textContent = '≡ƒæü∩╕Å';
                    if (text) text.textContent = 'View';
                } else {
                    if (icon) icon.textContent = '≡ƒÄ¿';
